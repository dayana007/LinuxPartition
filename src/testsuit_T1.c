...
void* TD0( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				 /* Prepare test */
				 u64TimeIndexTD0 = 0;
				 memset( u64ResTD0, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0.0;
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD0[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD0[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD0[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD0[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD0[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD0[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD0[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD0[u64Index+7];
        					}
    				}
			...
			case TESTID_CACHE_INITTEST_JUMP:
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD1[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD1[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD1[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD1[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD1[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD1[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD1[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD1[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
			...
			case TESTID_CACHE_INITTEST_JUMP:
				 ...
				 while(1)
				 {
					 	  sem_wait(&mutex_T1);
							...
							for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
							{
        					cArrTemp[u64Index] = cArrTD2[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD2[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD2[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD2[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD2[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD2[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD2[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD2[u64Index+7];
        					}
    					}
							clock_gettime( CLOCK_REALTIME, &timeEnd );
							sem_post(&mutex_T1);
						...
						while(1)
				 		{
								...
								for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
								{
        						cArrTemp[u64Index] = cArrTD3[u64Index];
        						if( u64Index < ( SIZE_10MB - 8 ) )
										{
            						cArrTemp[u64Index+1] = cArrTD3[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD3[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD3[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD3[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD3[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD3[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD3[u64Index+7];
        						}
    						}
								clock_gettime( CLOCK_REALTIME, &timeEnd );
								sem_post(&mutex_T1);
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				...
				while(1)
				{
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD4[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD4[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD4[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD4[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD4[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD4[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD4[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD4[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				...
				while(1)
				{
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD5[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD5[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD5[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD5[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD5[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD5[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD5[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD5[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
			...
			case TESTID_CACHE_INITTEST_JUMP:
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD6[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD6[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD6[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD6[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD6[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD6[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD6[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD6[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
			...
			case TESTID_CACHE_INITTEST_JUMP:
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD7[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD7[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD7[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD7[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD7[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD7[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD7[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD7[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				 ...
				 while(1)
				 {
							...
							for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
							{
        					cArrTemp[u64Index] = cArrTD8[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD8[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD8[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD8[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD8[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD8[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD8[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD8[u64Index+7];
        					}
    					}
							clock_gettime( CLOCK_REALTIME, &timeEnd );
							sem_post(&mutex_T1);
						...
						while(1)
				 		{
								...
								for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
								{
        						cArrTemp[u64Index] = cArrTD9[u64Index];
        						if( u64Index < ( SIZE_10MB - 8 ) )
										{
            						cArrTemp[u64Index+1] = cArrTD9[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD9[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD9[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD9[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD9[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD9[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD9[u64Index+7];
        						}
    						}
								clock_gettime( CLOCK_REALTIME, &timeEnd );
								sem_post(&mutex_T1);
...
void* TD10( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				 /* Prepare test */
				 u64TimeIndexTD10 = 0;
				 memset( u64ResTD10, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0.0;
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD10[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD10[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD10[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD10[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD10[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD10[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD10[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD10[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
...
void* TD11( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD11 = 0;
				 memset( u64ResTD11, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD11[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD11[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD11[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD11[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD11[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD11[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD11[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD11[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
  ...
  switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD12 = 0;
				 memset( u64ResTD12, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				 ...
				 while(1)
				 {
					    sem_wait(&mutex_T1);
							...
							for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
							{
        					cArrTemp[u64Index] = cArrTD12[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD12[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD12[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD12[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD12[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD12[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD12[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD12[u64Index+7];
        					}
    					}
							clock_gettime( CLOCK_REALTIME, &timeEnd );
							sem_post(&mutex_T1);
...
void* TD13( void* argt )
{
	...
	switch( iTestSuitID )
	{
        case TESTID_CACHE_INITTEST_JUMP:
				  	/* Prepare test */
				 		u64TimeIndexTD13 = 0;
				 		memset( u64ResTD13, 0.0, SIZE_1MB );
				 		u64TimeInSecs = 0;
						...
						while(1)
				 		{
								...
								for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
								{
        						cArrTemp[u64Index] = cArrTD13[u64Index];
        						if( u64Index < ( SIZE_10MB - 8 ) )
										{
            						cArrTemp[u64Index+1] = cArrTD13[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD13[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD13[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD13[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD13[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD13[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD13[u64Index+7];
        						}
    						}
								clock_gettime( CLOCK_REALTIME, &timeEnd );
								sem_post(&mutex_T1);
...
void* TD14( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD14 = 0;
				 memset( u64ResTD14, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				...
				while(1)
				{
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD14[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD14[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD14[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD14[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD14[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD14[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD14[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD14[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
...
void* TD15( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD15 = 0;
				 memset( u64ResTD15, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				...
				while(1)
				{
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD15[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD15[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD15[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD15[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD15[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD15[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD15[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD15[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
...
void* TD16( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				 /* Prepare test */
				 u64TimeIndexTD16 = 0;
				 memset( u64ResTD16, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0.0;
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD16[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD16[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD16[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD16[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD16[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD16[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD16[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD16[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
...
void* TD17( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD17 = 0;
				 memset( u64ResTD17, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				 ...
				 while(1)
				 {
					  sem_wait(&mutex_T1);
						...
						for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
						{
        					cArrTemp[u64Index] = cArrTD17[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD17[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD17[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD17[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD17[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD17[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD17[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD17[u64Index+7];
        					}
    				}
						clock_gettime( CLOCK_REALTIME, &timeEnd );
						sem_post(&mutex_T1);
...
void* TD18( void* argt )
{
	...
	switch( iTestSuitID )
	{
			case TESTID_CACHE_INITTEST_JUMP:
				  /* Prepare test */
				 u64TimeIndexTD18 = 0;
				 memset( u64ResTD18, 0.0, SIZE_1MB );
				 u64TimeInSecs = 0;
				 ...
				 while(1)
				 {
					 	  sem_wait(&mutex_T1);
							...
							for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
							{
        					cArrTemp[u64Index] = cArrTD18[u64Index];
        					if( u64Index < ( SIZE_10MB - 8 ) )
									{
            						cArrTemp[u64Index+1] = cArrTD18[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD18[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD18[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD18[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD18[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD18[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD18[u64Index+7];
        					}
    					}
							clock_gettime( CLOCK_REALTIME, &timeEnd );
							sem_post(&mutex_T1);
  ...
  switch( iTestSuitID )
	{
        case TESTID_CACHE_INITTEST_JUMP:
				  	/* Prepare test */
				 		u64TimeIndexTD19 = 0;
				 		memset( u64ResTD19, 0.0, SIZE_1MB );
				 		u64TimeInSecs = 0;
						...
						while(1)
				 		{
								...
								for( u64Index = 0; u64Index < SIZE_10MB; u64Index = u64Index + 8 )
								{
        						cArrTemp[u64Index] = cArrTD19[u64Index];
        						if( u64Index < ( SIZE_10MB - 8 ) )
										{
            						cArrTemp[u64Index+1] = cArrTD19[u64Index+1];
            						cArrTemp[u64Index+2] = cArrTD19[u64Index+2];
            						cArrTemp[u64Index+3] = cArrTD19[u64Index+3];
            						cArrTemp[u64Index+4] = cArrTD19[u64Index+4];
            						cArrTemp[u64Index+5] = cArrTD19[u64Index+5];
            						cArrTemp[u64Index+6] = cArrTD19[u64Index+6];
            						cArrTemp[u64Index+7] = cArrTD19[u64Index+7];
        						}
    						}
								clock_gettime( CLOCK_REALTIME, &timeEnd );
								sem_post(&mutex_T1);
